...
const faqs = [
  {
    question: "Can I automate LCAs with BhoomlPath?",
    answer: "Yes, BhoomlPath allows you to automate many aspects of LCA calculations through our advanced parameter-based system and integration capabilities."
  },
  {
    question: "What standards do you comply with?",
    answer: "BhoomlPath complies with ISO 14040/14044 standards and integrates with major LCA databases and methodologies used internationally."
  },
  {
  ...
  },
  {
    ...
    answer: "No, BhoomlPath includes access to necessary background databases as part of our service, eliminating the need for separate licensing."
  },
  {
  ...
  },
  {
    ...
    answer: "Absolutely. BhoomlPath supports comprehensive life cycle modeling including supply chain, logistics, product use phase, and end-of-life scenarios."
  },
  {
  ...
  {
    question: "Can I run scenarios and simulations in BhoomlPath?",
  ...
  },
  {
    ...
    answer: "Yes, we offer a free trial that allows you to explore BhoomlPath's capabilities with your own data before committing to a subscription."
  }
];
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div 
              key={index}
              className="bhoomlpath-card rounded-xl overflow-hidden animate-fade-in"
